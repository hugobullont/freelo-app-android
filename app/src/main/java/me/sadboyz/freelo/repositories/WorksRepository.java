...
public class WorksRepository {
    ...
    public WorksRepository AddWorkToDatabase(String name, String description, Double basePrice, Double pubPrice, String date, String createdBy, String workedBy, String idCategory, String status)
    {
        ...
        DataReference.getInstance().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                while(iterable.iterator().hasNext()){
                    ...
                    if(work.getStatus()!="close")works.add(work);
                }
            }
