...
public class WorksRepository {
    ...
    public WorksRepository AddWorkToDatabase(String name, String description, Double basePrice, Double pubPrice, String createdBy, String workedBy, String idCategory)
    {
        String key = DataReference.getInstance().child("works").push().getKey();
        String date = Calendar.getInstance().getTime().toString();
        Work work = new Work(key,name,description,basePrice,pubPrice,date,createdBy,workedBy,idCategory,"open");
